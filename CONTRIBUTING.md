...
issue](https://github.com/khulnasoft-lab/domain-manager/issues) in this
...
request](https://github.com/khulnasoft-lab/domain-manager/pulls), you will
...
```console
cd domain-manager
pyenv virtualenv <python_version_to_use> domain-manager
pyenv local domain-manager
